				...
				<view v-if="!inputVal">
					...
					<view class="hot-city">
						...
						<view class="city-names">
							<view class="city-name-item" v-for="(item,index) in hotProvince" :key="index" hover-class="tap-city" :hover-stay-time="150"
	...
	export default {
		data() {
			return {
				...
				inputVal: '', // 搜索框输入的内容
				hotProvince: ['云南', '新疆', '广西', '福建', '贵州', '湖北', '陕西', '四川', '西藏', '河南', '河北', '辽宁', '山东', '广东', '宁夏', '青海', '甘肃', '内蒙古', '黑龙江', '吉林', '山西', '湖南', '安徽', '江西'], // 热门城市
